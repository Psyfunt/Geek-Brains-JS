...
buttons.forEach(element => element.addEventListener('click', clickHandler));
...
function showCategory(category) {
   switch (category) {
      case "phones":
         products.phones.forEach(product => divProducts.insertAdjacentHTML('afterbegin', getProductMarkup(product)))
         break;
      case "tablets":
         products.tablets.forEach(product => divProducts.insertAdjacentHTML('afterbegin', getProductMarkup(product)))
         break;
      case "tv":
         products.tv.forEach(product => divProducts.insertAdjacentHTML('afterbegin', getProductMarkup(product)))
         break;
   }
}
